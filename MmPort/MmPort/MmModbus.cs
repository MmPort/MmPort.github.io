...
namespace MmPort
{
    public class MmModbus : MmPort
    {
        ...
        {
            if (tYPE == Common.CommunicationType.Modbus)
            {
        ...
        private void MmPort_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            try
            {
                int i;
